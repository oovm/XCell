namespace dataTable {
    ...
    export class MonstersTable {
        private static instance: MonstersTable;
        private monsters: Monster[] = [];

        /**
         * 获取单例实例
         */
        public static getInstance(): MonstersTable {
            if (!MonstersTable.instance) {
                MonstersTable.instance = new MonstersTable();
            }
            return MonstersTable.instance;
        }
         ...
         */
        public load(): void {
            const data = DataTableManager.getInstance().getTable<Monster[]>('Monsters');
            if (data) {
                this.monsters = data;
            }
        }

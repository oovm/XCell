...
XCell 提供了与 Vue 框架的深度集成，支持生成 TypeScript 代码、JSON 数据文件等多种格式。

## 配置选项

在 `XCell.toml` 文件中，Vue 集成配置位于 `[vue]` 部分：
...
5. **使用 Vue 组合式 API**：利用生成的组合式 API 函数简化数据加载和状态管理

## 示例项目

XCell 提供了 Vue 示例项目，展示了如何在实际项目中使用 XCell：
...
通过示例项目，您可以快速了解 XCell 在 Vue 中的最佳实践。

...
impl ParseError {
    ...
    pub fn new(kind: ParseErrorKind, position: usize) -> Self {
        let message = match &kind {
            ...
            ParseErrorKind::UnclosedBracket { bracket } => format!("未闭合的括号: {}", bracket),
            ParseErrorKind::UnclosedAngleBracket => "未闭合的尖括号".to_string(),
    ...
    /// 创建未闭合括号错误
    pub fn unclosed_bracket(bracket: char, position: usize) -> Self {
        Self::new(ParseErrorKind::UnclosedBracket { bracket }, position)
    }
}
